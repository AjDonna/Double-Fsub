...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7496307616:AAEJl5F-cfscm0LKUwp6U2N4saO-f2PbTg8")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002634536245"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1632095203"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002286003446"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1001730623330"))
...
try:
    ADMINS=[6066102279]
    for x in (os.environ.get("ADMINS", "1889175355 6303508073 7211073530 1632095203").split()):
        ADMINS.append(int(x))
except ValueError:
